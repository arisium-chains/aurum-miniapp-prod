...
// } from '@/lib/attractiveness-engine';
import {
  attractivenessEngineV2 as attractivenessEngine,
  attractivenessEngineV2Simulated as attractivenessEngineSimulated,
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            'You have already been scored. Only one scoring session is allowed per user.',
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            'Face quality is too low for accurate scoring. Please ensure good lighting, frontal angle, and clear resolution.',
