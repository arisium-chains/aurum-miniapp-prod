...
export function ProfileCard({ 
  ...
  const currentPhoto = profile.photos[currentPhotoIndex] || '/placeholder-profile.svg'
  const universityName = UNIVERSITY_NAMES[profile.university as keyof typeof UNIVERSITY_NAMES] || profile.university
